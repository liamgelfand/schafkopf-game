...
def upgrade() -> None:
    ...
    sa.Column('schneider_count', sa.Integer(), nullable=True),
    sa.Column('schwarz_count', sa.Integer(), nullable=True),
    ...
    sa.Column('card_sort', sa.String(), nullable=True),
    sa.Column('auto_sort_cards', sa.Boolean(), nullable=True),
